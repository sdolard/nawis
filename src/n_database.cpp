...
int NDatabase::getFileListCount(const QString & search,
...
bool NDatabase::getDuplicatedFileList(QScriptEngine & se, QScriptValue & dataArray,
									   const QString & search, int start,
									   int limit, NFileCategory_n::FileCategory fc,
									   const QString & sort, const QString & dir)
{
	QSqlQuery query(m_db);
...
int NDatabase::getDuplicatedFileListCount(const QString & search, NFileCategory_n::FileCategory fc)
{
	QSqlQuery query(m_db);
	QString sql = "SELECT COUNT(*) " \
				  "FROM files, duplicated_files "\
...
int NDatabase::getUserListCount(const QString & search)
{
	QSqlQuery query(m_db);
...
int NDatabase::getMusicAlbumListCount(const QString & search, int year, const QString & genre,
									   const QString & artist)
{
	NStringMapList list;
	QSqlQuery query(m_db);
...
bool NDatabase::getMusicArtistList(QScriptEngine & se, QScriptValue & dataArray,
									int totalCount, const QString & search, int start,
...
int NDatabase::getMusicArtistListCount(const QString & search, int year, const QString & genre)
{
	QSqlQuery query(m_db);
...
int NDatabase::getMusicGenreListCount(const QString & search, int year)
{
	QSqlQuery query(m_db);
...
int NDatabase::getMusicYearListCount(const QString & search)
{
	QSqlQuery query(m_db);
...
int NDatabase::getMusicTitleListCount(const QString & search, const QString & album,
									   const QString & artist, const QString & genre,  
									   int year)
{
	QSqlQuery query(m_db);
